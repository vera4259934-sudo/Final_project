...
//            "img/popitka1.png");
    ...
    public void actionPerformed(ActionEvent event) {
      ...
      //        Sys//        tem.out.println("\t" + product.getName() + ": " + quantityPopup.getValue());
   ...
   //rivate final NewProduct spoon;
    ...
    public Level_2() {
        ...
        quantityPopupsMap.put(sugar, new QuantityPopup("sugar", 0, 5, 1,
                ...
                new Rectangle(28, 104, 54 - 28 + 1, 140 - 104 + 1),
                new Rectangle(177, 152, 219 - 177 + 1, 174 - 152 + 1), this));
        quantityPopupsMap.put(iceCubes, new QuantityPopup("ice", 0, 10, 5,
                "img/ice_quantity.png",
                new Rectangle(329, 104, 362 - 329 + 1, 140 - 104 + 1),
                new Rectangle(28, 104, 54 - 28 + 1, 140 - 104 + 1),
                new Rectangle(177, 152, 219 - 177 + 1, 174 - 152 + 1), this));

        quantityPopupsMap.put(iceHearts, new QuantityPopup("ice2", 0, 10, 5,
                "img/ice_quantity.png",
                new Rectangle(329, 104, 362 - 329 + 1, 140 - 104 + 1),
                new Rectangle(28, 104, 54 - 28 + 1, 140 - 104 + 1),
                new Rectangle(177, 152, 219 - 177 + 1, 174 - 152 + 1), this));
        quantityPopupsMap.put(iceStars, new QuantityPopup("ice3", 0, 10, 5,
                "img/ice_quantity.png",
                new Rectangle(329, 104, 362 - 329 + 1, 140 - 104 + 1),
                new Rectangle(28, 104, 54 - 28 + 1, 140 - 104 + 1),
                new Rectangle(177, 152, 219 - 177 + 1, 174 - 152 + 1), this));

        quantityPopupsMap.put(topiokaBrown, new QuantityPopup("topioka", 0, 200, 110,
                "img/tapioka_quantity.png",
                new Rectangle(329, 104, 362 - 329 + 1, 140 - 104 + 1),
                new Rectangle(28, 104, 54 - 28 + 1, 140 - 104 + 1),
                new Rectangle(177, 152, 219 - 177 + 1, 174 - 152 + 1), this));
        ...
        quantityPopupsMap.put(topiokaPink, new QuantityPopup("topioka2", 0, 200, 110,
                "img/tapioka_quantity.png",
                new Rectangle(329, 104, 362 - 329 + 1, 140 - 104 + 1),
                new Rectangle(28, 104, 54 - 28 + 1, 140 - 104 + 1),
                new Rectangle(177, 152, 219 - 177 + 1, 174 - 152 + 1), this));
        quantityPopupsMap.put(topiokaYellow, new QuantityPopup("topioka3", 0, 200, 110,
                "img/tapioka_quantity.png",
                new Rectangle(329, 104, 362 - 329 + 1, 140 - 104 + 1),
                new Rectangle(28, 104, 54 - 28 + 1, 140 - 104 + 1),
                new Rectangle(177, 152, 219 - 177 + 1, 174 - 152 + 1), this));

        quantityPopupsMap.put(teaBlack, new QuantityPopup("tea", 0, 5, 1,
                "img/tea_quantity.png",
                new Rectangle(329, 104, 362 - 329 + 1, 140 - 104 + 1),
                new Rectangle(28, 104, 54 - 28 + 1, 140 - 104 + 1),
                new Rectangle(177, 152, 219 - 177 + 1, 174 - 152 + 1), this));

        quantityPopupsMap.put(teaGreen, new QuantityPopup("tea2", 0, 5, 1,
                "img/tea_quantity.png",
                new Rectangle(329, 104, 362 - 329 + 1, 140 - 104 + 1),
                new Rectangle(28, 104, 54 - 28 + 1, 140 - 104 + 1),
                new Rectangle(177, 152, 219 - 177 + 1, 174 - 152 + 1), this));
