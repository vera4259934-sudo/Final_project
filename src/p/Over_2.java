...
public class Over_2 extends JPanel {
    private LayersContainer container;
    private Image backgroundImage;
    private JLabel nextButton;

    private MistakeCounter2 mistakeCounter2;

    void setMistakeCounter2(MistakeCounter2 mistakeCounter2) {
        this.mistakeCounter2 = mistakeCounter2;
    }
   ...
   // private MistakeCounter mistakeCounter = MistakeCounter.getSharedInstance();
    ...
    public Over_2() {
        ...
        backgroundImage = new ImageIcon(getClass().getClassLoader().getResource("img/Over_2_screen.png")).getImage();
        ...
        nextButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                container.showLayer(LayersContainer.Layer.THANKS);
            }
        });
    }
    ...
    public void setVisible(boolean b) {
        super.setVisible(b);
        if(b) {
            int mistakeAmount = mistakeCounter2.getMistakeAmount();
